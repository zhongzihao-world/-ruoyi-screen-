<template>
  ...
  <el-form-item label="文本颜色">
    <el-color-picker
      ...
      @active-change="(val: string) => (optionData.color = val)"
    />
  </el-form-item>
  ...
  <el-form-item label="动画设置">
    <FormSettingBox>
      <FormSettingItem name="速度">
        <el-input-number v-model="optionData.animationSpeed" />
      </FormSettingItem>

      <FormSettingItem name="间隔">
        <el-input-number v-model="optionData.animationTime" />
      </FormSettingItem>
    </FormSettingBox>
  </el-form-item>
</template>
